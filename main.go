...
import (
	...
	"github.com/dippynark/scm-controller/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2c59d777.dippynark.co.uk",
	})
	if err != nil {
	...
	if err = (&scmv1alpha1.GitHubWebhook{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "GitHubWebhook")
		os.Exit(1)
	}
